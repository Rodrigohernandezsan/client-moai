...
export default class UpdateCourse extends Component {
  ...
  getCourseData = () => {
    axios.get(`REACT_APP_API_BASE_URL + ${this.props.match.params.id}`)
      .then(res => {
  ...
  updateCourse = (auth) => {
    ...
    axios.put(`REACT_APP_API_BASE_URL + ${this.props.match.params.id}`, formData, { headers: { "Authorization": auth } })
