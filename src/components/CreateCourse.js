...
export default class CreateCourse extends Component {
  ...
  createCourse = (auth) => {
    ...
    axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/courses/`, formData, { headers: { 'Authorization': auth } })
      .then(() => {
        this.setState({
          created: true
        });
                  ...
                  <form onSubmit={(e) => {
                    ...
                    <div className="grid-66">
                      <div className="course--header">
                        ...
                        <div>
                          <input id="title" name="title" type="text" className="input-title course--title--input" placeholder="Resources title..."
                            value={this.state.title} onChange={(e) => this.handleChange(e, 'title')} />
                        </div>
                        <p>✍️ By Rodrigo Hernández</p>
                      </div>
                    ...
                    <div className="grid-100 pad-bottom">
                      <button className="button" type="submit">Create resources</button>
